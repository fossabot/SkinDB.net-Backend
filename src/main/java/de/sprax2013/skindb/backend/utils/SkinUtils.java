...
public class SkinUtils {
    ...
    private static final Point[] SKIN_3PX = {new Point(0, 8), new Point(0, 9), new Point(0, 10), new Point(0, 11),
     ...
     * <i>SKIN_3PX</i> and <i>SKIN_4PX_DIFF</i> would be all pixels used by a
     * 4px-Skin
     */
    ...
    public static BufferedImage toCleanSkin(BufferedImage img) {
        ...
        // FIXME: Die textur muss gespiegelt werden.
        //  Wenn ich einen roten Punkt auf den rechten Arm setzen, ist er sonst auf dem linken Arm am Körper statt außen
        //  Testen: https://minecrafthub.com/skin/knight-templar/download
        if (isLegacySkin(img)) {
     ...
     * @see #hasSkinDimensions(BufferedImage)
     */
    private static boolean isLegacySkin(BufferedImage img) {
